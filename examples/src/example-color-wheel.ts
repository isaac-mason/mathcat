...
import { color, hsl } from 'mathcat/color';
...
// mathcat/color (hsl.toColor -> color.toSRGB). Move the pointer to pick a colour;
// the readout shows its HSL / RGB / hex, all via mathcat/color.
...
// build a triangulated disk; each vertex is coloured by mathcat/color
