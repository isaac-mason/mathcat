...
import { type Euler, euler, type Quat, quat } from 'mathcat';
import { mulberry32 } from 'mathcat/random';

// One orientation, two ways to interpolate it between random keyframes. The solid
// colour-cube uses mathcat's quat.slerp (constant-speed shortest arc). The
...
function frame(tms: number) {
    ...
    // mathcat: slerp — constant angular velocity along the shortest arc
